...
export const Hora=()=>{
    ...
    return(
        ...
        <div className="body">
            ...
            <div className="input">
                <input type="text" onChange={(event)=> Setsegundo(event)} value={seg} className="form-control"/>
                <p></p>
                <button  onClick={() =>Cambiarhora(seg)} className="btn btn-success">Convertir la Hora</button>
                <p>{horaCambiada}</p>
            </div>
