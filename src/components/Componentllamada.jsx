        ...
        <>
            <div className="body2">
                ...
                <div className="input2">
                    <input type="text" onChange={(event) => Setlla(event)} value={minutos} className="form-control"/>
                    <p></p>
                    <button onClick={() => pago(minutos)} className="btn btn-success">valor a cobrar</button>
                    <p>
