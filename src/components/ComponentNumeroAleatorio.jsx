        ...
        <>
            <div className="body8">
               ...
               <div className="input8">
                <button onClick={() => generarArray()} className="btn btn-success">Generar 10 numeros aleatorios</button>
                    <p>el arreglo original es {numeros}</p>
                    <p></p>
                    <input type="text" onChange={(event) => onNum(event)} value={num} placeholder="Ingrese número" className="form-control" />

                    <p></p>
                    <button onClick={() => imprimir([numeros], num)} className="btn btn-success">Agregar aumento</button>
                    <p> {sal} </p>
               </div>
