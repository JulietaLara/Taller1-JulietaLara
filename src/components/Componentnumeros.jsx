        ...
        <>
            <div className="body4">
                ...
                <div className="input4">
                    <input type="text" onChange={(event) => Set1(event)} value={pnumero} placeholder="Primer número" className="form-control" />
                    <input type="text" onChange={(event) => Set2(event)} value={snumero} placeholder="Segundo número" className="form-control"/>
                    <input type="text" onChange={(event) => Set3(event)} value={tnumero} placeholder="Tercer número" className="form-control" />
                    <p></p>
                    <button onClick={() => numerosIguales()} className="btn btn-success">Hey! Click me</button>
                    <p>{sal}</p>
                    <p></p>
                    <p>{categories}</p>
                </div>
