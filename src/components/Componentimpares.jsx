        ...
        <>
            <div className="body6">
                ...
                <div className="input6">
                    <input type="text" onChange={(event) => Setnum(event)} value={numero} placeholder="Número" className="form-control"/>
                    <p></p>
                    <button onClick={() => numerosImpares(numero)} className="btn btn-success">Sacar impares</button>
                    <p>
