        ...
        <>
            <div className="body7">
                ...
                <div className="input7">
                    <input type="text" onChange={(event) => onSal(event)} value={newSal} placeholder="Agregar salario" className="form-control" />
                    <p></p>
                    <button onClick={() => onAddSal(newSal)} className="btn btn-success">Agregar salario</button>
                    <p></p>
                    <button onClick={() => agregarAumento([salarios])} className="btn btn-success">Calcular aumento</button>
                    <p> {sal} </p>
                </div>
